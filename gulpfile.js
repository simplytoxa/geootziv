...
gulp.task('serve', () => {
  ...
  browserSync.watch(['./build/js/bundle.min.js', './build/**/*.html', '!**/*.scss', path.sprite.spriteImgDest], browserSync.reload);
});
...
gulp.task('watch', () => {
  ...
  gulp.watch(path.jsWatch, gulp.series('script', 'lint'));
